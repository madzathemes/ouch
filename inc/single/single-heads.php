<?php function ouch_single_cat() {?>

  <div class="single-cat-wrap"><?php echo get_the_category_list(); ?></div>

<?php } ?>
<?php function ouch_single_cat_posts() {
...
<?php function ouch_single_title() { $subtitle = get_post_meta(get_the_ID(), "magazin_subtitle", true); ?>
...
<?php } ?>
<?php function ouch_single_social() {
$share_top = "";
