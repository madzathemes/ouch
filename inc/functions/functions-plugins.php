...
add_action( 'tgmpa_register', 'ouch_register_required_plugins' );
/**
 ...
 */
function ouch_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name'			=> esc_html__( "Envato WordPress Toolkit","ouch" ), // The plugin name
        ...
        array(
        			'name'     				=> esc_html__( "Page Builder by SiteOrigin","ouch" ), // The plugin name
        			'slug'     				=> 'siteorigin-panels', // The plugin slug (typically the folder name)
        			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
              'force_activation'		=> false,
        ),
        array(
        			'name'     				=> esc_html__( "One Click Demo Import","ouch" ), // The plugin name
        			'slug'     				=> 'one-click-demo-import', // The plugin slug (typically the folder name)
        			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
              'force_activation'		=> false,
        ),
        array(
            'name'			=> esc_html__( "Magazine Plug","ouch" ), // The plugin name
     ...
     */
    $config = array(
      'id'           => 'ouch',                // Unique ID for hashing notices for multiple instances of TGMPA.
